       ...
       <div class="row ">
            ...
            <div class="row ">
                <div class="col-md-6 my-3 ">
                  ...
                  <div class="col-md-6 my-3 ">
                    <div class="d-flex justify-content-between">
                        <label for="tituloVideo-${caso.cexi_ID}" class="form-label fw-semibold">Descripcion Seccion</label>                        
                    </div>


                    <textarea type="text" id="tituloVideo-${caso.cexi_ID}" class="form-control" placeholder="${caso.cexi_TituloVideo}" disabled></textarea>
