    ...
    public class TestController : Controller
    {
        ...
        public async Task<IActionResult> ListarTest()
        {
            ...
            catch (Exception ex)
            {
                ...
                {
                    success = false,
                    message = "Ocurrio un error al intentar obtener los test. Por favor, int�ntelo nuevamente.",
        ...
        public async Task<IActionResult> ListarMaestros()
        {
            ...
            catch (Exception ex)
            {
                ...
                {
                    success = false,
                    message = "Ocurri� un error al intentar obtener los maestros. Por favor, int�ntelo nuevamente.",
                    error = ex.Message // Esto es �til para depuraci�n, puedes eliminarlo en producci�n.
                });
            }
        }
        ...
        public async Task<IActionResult> ObtenerTest(int id)
        {
            try
            {
                var test = await _testBL.ObtenerTestPorIdAsync(id); // Cambio a versi�n asincr�nica
                if (test != null)
                {
                    return Json(new
                    {
